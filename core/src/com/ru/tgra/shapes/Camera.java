...
public class Camera {
	...
	public void slideX(float delU, float delV, float delN)
	{
		eye.x += delU*u.x + delV*v.x + delN*n.x;
		//eye.y += delU*u.y + delV*v.y + delN*n.y;
		//eye.z += delU*u.z + delV*v.z + delN*n.z;
	}
	public void slideZ(float delU, float delV, float delN)
	{
		//eye.x += delU*u.x + delV*v.x + delN*n.x;
		//eye.y += delU*u.y + delV*v.y + delN*n.y;
		eye.z += delU*u.z + delV*v.z + delN*n.z;
	...
	public float checkSlideX(float delU, float delV, float delN)
	{
		return delU*u.x + delV*v.x + delN*n.x;
	}
	public float checkSlideZ(float delU, float delV, float delN)
	{
		return delU*u.z + delV*v.z + delN*n.z;
	}
	...
	public void pitch(float angle)
	{
		...
		//v.set(t.x * s + v.x * c, t.y * s + v.y * c, t.z * s + v.z * c);
		if(0.9 > (t.y * c - v.y * s) && -0.9 < (t.y * c - v.y * s)) {
			n.set(t.x * c - v.x * s, t.y * c - v.y * s, t.z * c - v.z * s);
			v.set(t.x * s + v.x * c, t.y * s + v.y * c, t.z * s + v.z * c);
